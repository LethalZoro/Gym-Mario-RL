...
if __name__ == "__main__":
    ...
    with open("avg_rewards.csv", "w") as f:
        for reward in avg_rewards:
            f.write(f"{reward}\n")

    with open("avg_game_scores.csv", "w") as f:
        for game_score in avg_game_scores:
            f.write(f"{game_score}\n")

    with open("avg_steps_per_episode.csv", "w") as f:
        for steps in avg_steps_per_episode:
            f.write(f"{steps}\n")

    with open("training_times.csv", "w") as f:
        for time in training_times:
            f.write(f"{time}\n")

    # Print average metrics over all episodes
    with open("avg_metrics.csv", "w") as f:
        # column headers
        f.write(
